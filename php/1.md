...
_Grandes proyectos han sido hechos éxitos internacionales con PHP, como Facebook (que recientemente inventó su propia versión modificara de PHP llamada [Hack](http://hacklang.org/). PHP es además el lenguaje de programación con el que funciona WordPress, el cual en Septiembre de por si solo posibilita la existencia de más del 58% de las webs con CMS conocidos, y más de un 24% de la totalidad de las webs existentes en internet.  \
